...
import com.penguinlearner.data.models.InferenceQuizQuestion
...
@Composable
fun InferenceQuizScreen(
    contentRepository: ContentRepository,
    progressRepository: ProgressRepository,
    onNavigateBack: () -> Unit
) {
    val scope = rememberCoroutineScope()
    var questions by remember { mutableStateOf<List<InferenceQuizQuestion>>(emptyList()) }
    ...
    LaunchedEffect(Unit) {
        questions = contentRepository.loadInferenceQuiz().shuffled()
    }
    ...
    if (showSummary) {
        QuizSummaryScreen(
            ...
            onTryAgain = {
                ...
                scope.launch {
                    progressRepository.resetInferenceQuizScore()
                }
            },
            ...
            Button(
                onClick = {
                    if (selectedAnswerIndex != null) {
                        ...
                        scope.launch {
                            progressRepository.updateInferenceQuizScore(isCorrect)
                        }
                    }
                },
                modifier = Modifier.fillMaxWidth(),
