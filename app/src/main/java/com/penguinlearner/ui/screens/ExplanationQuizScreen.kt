...
import com.penguinlearner.data.models.ExplanationQuizQuestion
...
@Composable
fun ExplanationQuizScreen(
    contentRepository: ContentRepository,
    progressRepository: ProgressRepository,
    onNavigateBack: () -> Unit
) {
    val scope = rememberCoroutineScope()
    var questions by remember { mutableStateOf<List<ExplanationQuizQuestion>>(emptyList()) }
    ...
    LaunchedEffect(Unit) {
        questions = contentRepository.loadExplanationQuiz().shuffled()
    }
    ...
    if (showSummary) {
        ExplanationQuizSummaryScreen(
            ...
            onTryAgain = {
                ...
                scope.launch {
                    progressRepository.resetExplanationQuizScore()
                }
            },
            ...
            Button(
                onClick = {
                    if (selectedAnswerIndex != null) {
                        ...
                        scope.launch {
                            progressRepository.updateExplanationQuizScore(isCorrect)
                        }
                    }
                },
                modifier = Modifier.fillMaxWidth(),
...
@Composable
private fun ExplanationQuizSummaryScreen(
    score: Int,
    total: Int,
    onTryAgain: () -> Unit,
    onNavigateBack: () -> Unit
